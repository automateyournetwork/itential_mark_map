...
/**
 * Paths to files saved by auto-save
 */
...
/**
 * Paths to files saved for structure output (no SVG)
 */
export interface SavedStructureFilePaths {
  md: string;
  json: string;
}
...
export interface GetStructureOutput {
  ...
  saved_files?: SavedStructureFilePaths;
}
